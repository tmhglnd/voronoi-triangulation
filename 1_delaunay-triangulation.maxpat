...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 343.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 150.0, 559.0, 47.0 ],
					"text" : "A study on using delaunay triangulation and voronoi diagrams, calculated in JS with the new [v8] engine. The [v8] object uses the modern ES6 JS and is much faster than the old [js] object. Using the typed arrays Float32Array to calculate the triangulation on, instead of calculating on the matrix directly."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 555.0, 119.0, 20.0 ],
					"text" : "visualize input points"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 713.0, 241.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Study 1: Delaunay Triangulation"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 297.0, 225.0, 265.0, 22.0 ],
					"text" : "jit.gl.camera @fsaa 1 @ortho 2 @lens_angle 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 645.0, 264.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 375.0, 118.0, 22.0 ],
					"text" : "jit.time @speed 0.08"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 765.0, 454.0, 22.0 ],
					"text" : "jit.gl.mesh @draw_mode triangles @line_width 1.1 @poly_mode 1 1 @color 1 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 735.0, 105.0, 22.0 ],
					"text" : "route triangulation"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 105.0, 585.0, 409.0, 22.0 ],
					"text" : "jit.gl.mesh @draw_mode points @point_size 6 @color 1 0 0 0.5 @enable 0"
				}

			}
, 			{
				"box" : 				{
					"filename" : "1_triangulation.js",
					"id" : "obj-5",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 645.0, 115.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "v8 1_triangulation.js",
					"textfile" : 					{
						"filename" : "1_triangulation.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 236.0, 330.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 555.0, 150.0, 22.0 ]
				}
